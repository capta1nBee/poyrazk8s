...
@Entity
@Table(name = "cluster_roles")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class ClusterRole implements BaseK8sEntity {
    ...
    private String rules; // JSON array of PolicyRule

    @Column(columnDefinition = "TEXT")
    private String aggregationRule; // JSON
