...
@Entity
@Table(name = "custom_resource_definitions")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class CustomResourceDefinition implements BaseK8sEntity {
    ...
    private String versions; // JSON array

    private String scope; // Namespaced or Cluster

    @Column(columnDefinition = "TEXT")
    private String names; // JSON - kind, plural, singular, shortNames
