...
public class DaemonSet {
    ...
    @Column(name = "desired_number_scheduled")
    private Integer desiredNumberScheduled;

    @Column(name = "current_number_scheduled")
    private Integer currentNumberScheduled;

    @Column(name = "number_ready")
    private Integer numberReady;

    @Column(name = "number_available")
    private Integer numberAvailable;

    @Column(name = "node_selector", columnDefinition = "TEXT")
