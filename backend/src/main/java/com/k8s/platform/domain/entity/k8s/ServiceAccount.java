...
@NoArgsConstructor
@AllArgsConstructor
public class ServiceAccount implements BaseK8sEntity {
    ...
    private String secrets; // JSON array of secret references

    @Column(name = "image_pull_secrets", columnDefinition = "TEXT")
    private String imagePullSecrets; // JSON array
